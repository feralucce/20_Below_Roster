...
//
// Shared by the Battle Tracker and the Bestiary extension, which both need
// the same convention: an image sitting beside a character file with the
// same name - dire-wolf.json next to dire-wolf.png - belongs to it.
//
